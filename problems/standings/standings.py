...
<head>
    <!-- Load sentry as early as possible -->
            <script nonce="86674336e5d51b282dd0f8a6f864764e46cea3d07f88c71bb20e19b40764c44b" src="https://js.sentry-cdn.com/1ad5e9767ad243d396a93ef40135e743.min.js" crossorigin="anonymous" data-lazy="no"></script>

    <script nonce="86674336e5d51b282dd0f8a6f864764e46cea3d07f88c71bb20e19b40764c44b" type="module">
        Sentry.onLoad(function() {
            Sentry.init({
                dsn: "https://1ad5e9767ad243d396a93ef40135e743:0f66eac85d88443baa349f5bc2497f28@sentry.io/271015",
                release: "d29ef158e7492855a54ee2aa69b4219a1acf9f55",
                environment: "edu",
                whitelistUrls: [
    ...
    <script nonce="86674336e5d51b282dd0f8a6f864764e46cea3d07f88c71bb20e19b40764c44b" src="/assets/4dae4ca509f9a496f941d11c8184df13/jquery/dist/jquery.min.js"></script>
    <script nonce="86674336e5d51b282dd0f8a6f864764e46cea3d07f88c71bb20e19b40764c44b" src="/assets/4dae4ca509f9a496f941d11c8184df13/jquery-ui-dist/jquery-ui.min.js"></script>

    <!-- Timezone Cookie -->
    <script nonce="86674336e5d51b282dd0f8a6f864764e46cea3d07f88c71bb20e19b40764c44b" type="module" src="/js/85741cd290225b3df32e6a973a2090aa/modules/timezone.js"></script>
...
div.page-content.clearfix.above-everything.alert.alert-danger div.main-content { padding-bottom: 0; }
    ...
    <script nonce="86674336e5d51b282dd0f8a6f864764e46cea3d07f88c71bb20e19b40764c44b" type="text/javascript">
    ...
    jQuery.ns = function (namespace) {
     ...
     <script nonce="86674336e5d51b282dd0f8a6f864764e46cea3d07f88c71bb20e19b40764c44b" >
jQuery.extend(jQuery.ns('Kattis.error'), (function () {
    return {
        show_msg: function (base_message, kattis_message) {
            if (kattis_message) {
                alert(base_message + ": " + kattis_message);
            } else {
                alert(base_message);
            }
        },
        ...
        show_xhr_msg: function (elem, jqXHR) {
            ...
            var kattis_message = jqXHR.responseJSON && jqXHR.responseJSON.error &&
                       jqXHR.responseJSON.error.message;
            this.show_msg(base_message, kattis_message);
        }
    }
})());
</script>
...
<header class="l-page_header">
    ...
    <div class="page_header-wrapper">
        <div class="logo-container">
            ...
            <script nonce="86674336e5d51b282dd0f8a6f864764e46cea3d07f88c71bb20e19b40764c44b" type="module" src="/js/85741cd290225b3df32e6a973a2090aa/pages/master/nav.js"></script>
        </div>
...
<div class="top_bar ">
    <script nonce="86674336e5d51b282dd0f8a6f864764e46cea3d07f88c71bb20e19b40764c44b" type="module" src="/js/85741cd290225b3df32e6a973a2090aa/pages/master/top_bar.js"></script>
    <div class="branding_border"></div>
...
<script nonce="86674336e5d51b282dd0f8a6f864764e46cea3d07f88c71bb20e19b40764c44b" src="/assets/4dae4ca509f9a496f941d11c8184df13/moment/min/moment.min.js"></script>
<script nonce="86674336e5d51b282dd0f8a6f864764e46cea3d07f88c71bb20e19b40764c44b" src="/assets/4dae4ca509f9a496f941d11c8184df13/bootstrap-daterangepicker/daterangepicker.js"></script>
<script nonce="86674336e5d51b282dd0f8a6f864764e46cea3d07f88c71bb20e19b40764c44b" src="/assets/4dae4ca509f9a496f941d11c8184df13/select2/dist/js/select2.full.min.js"></script>




<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v84a3a4012de94ce1a686ba8c167c359c1696973893317" integrity="sha512-euoFGowhlaLqXsPWQ48qSkBSCFs3DPRyiwVu3FjR96cMPx+Fr+gpWRhIafcHwqwCqWS42RZhIudOvEI+Ckf6MA==" nonce="86674336e5d51b282dd0f8a6f864764e46cea3d07f88c71bb20e19b40764c44b" data-cf-beacon='{"rayId":"824885409f6e380b","b":1,"version":"2023.10.0","token":"6651308a007d4d459b12876077322bfb"}' crossorigin="anonymous"></script>
</body>
</html>
